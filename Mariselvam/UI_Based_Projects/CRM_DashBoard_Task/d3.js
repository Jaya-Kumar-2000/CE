(function (global, factory) {
  ...
  _exports.treemapDice = dice;
  _exports.treemapResquarify = void 0;
  _exports.treemapSlice = slice$1;
  ...
  _exports.bisectRight = _exports.bisect = bisectRight;
  var bisectLeft = ascendingBisect.left;
  _exports.bisectLeft = bisectLeft;
  ...
  _exports.interpolateRgb = interpolateRgb;
  ...
  _exports.interpolateRgbBasis = rgbBasis;
  var rgbBasisClosed = rgbSpline(basisClosed);
  _exports.interpolateRgbBasisClosed = rgbBasisClosed;
  function array(a, b) {
    var nb = b ? b.length : 0,
  ...
  _exports.interpolateTransformCss = interpolateTransformCss;
  var interpolateTransformSvg = interpolateTransform(parseSvg, ", ", ")", ")");
  _exports.interpolateTransformSvg = interpolateTransformSvg;
  var rho = Math.SQRT2,
    rho2 = 2,
    rho4 = 4,
    epsilon2 = 1e-12;
  ...
  var hsl$2 = hsl$1(hue);
  _exports.interpolateHsl = hsl$2;
  var hslLong = hsl$1(nogamma);
  _exports.interpolateHslLong = hslLong;
  ...
  var hcl$2 = hcl$1(hue);
  _exports.interpolateHcl = hcl$2;
  var hclLong = hcl$1(nogamma);
  _exports.interpolateHclLong = hclLong;
  ...
  _exports.interpolateCubehelix = cubehelix$2;
  var cubehelixLong = cubehelix$1(nogamma);
  _exports.interpolateCubehelixLong = cubehelixLong;
  ...
  _exports.easePolyInOut = _exports.easePoly = polyInOut;
  var pi = Math.PI,
    halfPi = pi / 2;
  function sinIn(t) {
  ...
  _exports.easeBackInOut = _exports.easeBack = backInOut;
  var tau = 2 * Math.PI,
    amplitude = 1,
    period = 0.3;
  ...
  _exports.easeElasticIn = elasticIn;
  ...
  _exports.easeElasticOut = _exports.easeElastic = elasticOut;
  ...
  _exports.easeElasticInOut = elasticInOut;
  var defaultTiming = {
    time: null,
    // Set on use.
    delay: 0,
  ...
  _exports.csvParseRows = csvParseRows;
  ...
  var formatPrefix;
  _exports.formatPrefix = formatPrefix;
  defaultLocale({
    decimal: ".",
    thousands: ",",
    grouping: [3],
  ...
  function squarifyRatio(ratio, parent, x0, y0, x1, y1) {
    ...
    while (i0 < n) {
      ...
      if (row.dice) dice(row, x0, y0, x1, value ? y0 += dy * sumValue / value : y1);else slice$1(row, x0, y0, value ? x0 += dx * sumValue / value : x1, y1);
  ...
  _exports.treemapSquarify = squarify;
  function index$1() {
    var tile = squarify,
      round = false,
      dx = 1,
  ...
  function sliceDice(parent, x0, y0, x1, y1) {
    (parent.depth & 1 ? slice$1 : dice)(parent, x0, y0, x1, y1);
  }
    ...
    function resquarify(parent, x0, y0, x1, y1) {
      if ((rows = parent._squarify) && rows.ratio === ratio) {
        ...
        while (++j < m) {
          ...
          if (row.dice) dice(row, x0, y0, x1, value ? y0 += (y1 - y0) * row.value / value : y1);else slice$1(row, x0, y0, value ? x0 += (x1 - x0) * row.value / value : x1, y1);
          value -= row.value;
        }
      } else {
  ...
  _exports.treemapResquarify = resquarify;
  var pi$1 = Math.PI,
    tau$1 = 2 * pi$1,
    epsilon$1 = 1e-6,
  ...
  _exports.utcMillisecond = _exports.timeMillisecond = millisecond;
  ...
  _exports.utcMilliseconds = _exports.timeMilliseconds = milliseconds;
  ...
  _exports.utcSecond = _exports.timeSecond = second;
  var seconds = second.range;
  _exports.utcSeconds = _exports.timeSeconds = seconds;
  ...
  _exports.timeMinute = minute;
  var minutes = minute.range;
  _exports.timeMinutes = minutes;
  ...
  _exports.timeHour = hour;
  var hours = hour.range;
  _exports.timeHours = hours;
  ...
  _exports.timeDay = day;
  var days = day.range;
  _exports.timeDays = days;
  function weekday(i) {
    return newInterval(function (date) {
  ...
  _exports.timeSunday = _exports.timeWeek = sunday;
  var monday = weekday(1);
  _exports.timeMonday = monday;
  var tuesday = weekday(2);
  _exports.timeTuesday = tuesday;
  var wednesday = weekday(3);
  _exports.timeWednesday = wednesday;
  var thursday = weekday(4);
  _exports.timeThursday = thursday;
  var friday = weekday(5);
  _exports.timeFriday = friday;
  var saturday = weekday(6);
  _exports.timeSaturday = saturday;
  var sundays = sunday.range;
  _exports.timeSundays = _exports.timeWeeks = sundays;
  var mondays = monday.range;
  _exports.timeMondays = mondays;
  var tuesdays = tuesday.range;
  _exports.timeTuesdays = tuesdays;
  var wednesdays = wednesday.range;
  _exports.timeWednesdays = wednesdays;
  var thursdays = thursday.range;
  _exports.timeThursdays = thursdays;
  var fridays = friday.range;
  _exports.timeFridays = fridays;
  var saturdays = saturday.range;
  _exports.timeSaturdays = saturdays;
  ...
  _exports.timeMonth = month;
  var months = month.range;
  _exports.timeMonths = months;
  ...
  _exports.utcMinute = utcMinute;
  var utcMinutes = utcMinute.range;
  _exports.utcMinutes = utcMinutes;
  ...
  _exports.utcHour = utcHour;
  var utcHours = utcHour.range;
  _exports.utcHours = utcHours;
  ...
  _exports.utcDay = utcDay;
  var utcDays = utcDay.range;
  _exports.utcDays = utcDays;
  ...
  _exports.utcSunday = _exports.utcWeek = utcSunday;
  var utcMonday = utcWeekday(1);
  _exports.utcMonday = utcMonday;
  var utcTuesday = utcWeekday(2);
  _exports.utcTuesday = utcTuesday;
  var utcWednesday = utcWeekday(3);
  _exports.utcWednesday = utcWednesday;
  var utcThursday = utcWeekday(4);
  _exports.utcThursday = utcThursday;
  var utcFriday = utcWeekday(5);
  _exports.utcFriday = utcFriday;
  var utcSaturday = utcWeekday(6);
  _exports.utcSaturday = utcSaturday;
  var utcSundays = utcSunday.range;
  _exports.utcSundays = _exports.utcWeeks = utcSundays;
  var utcMondays = utcMonday.range;
  _exports.utcMondays = utcMondays;
  var utcTuesdays = utcTuesday.range;
  _exports.utcTuesdays = utcTuesdays;
  var utcWednesdays = utcWednesday.range;
  _exports.utcWednesdays = utcWednesdays;
  var utcThursdays = utcThursday.range;
  _exports.utcThursdays = utcThursdays;
  var utcFridays = utcFriday.range;
  _exports.utcFridays = utcFridays;
  var utcSaturdays = utcSaturday.range;
  _exports.utcSaturdays = utcSaturdays;
  ...
  _exports.utcMonth = utcMonth;
  var utcMonths = utcMonth.range;
  _exports.utcMonths = utcMonths;
  ...
  var timeParse;
  _exports.timeParse = timeParse;
  var utcFormat;
  _exports.utcFormat = utcFormat;
  var utcParse;
  _exports.utcParse = utcParse;
  defaultLocale$1({
    dateTime: "%x, %X",
    date: "%-m/%-d/%Y",
    time: "%-I:%M:%S %p",
  ...
  _exports.isoFormat = formatIso;
  function parseIsoNative(string) {
    var date = new Date(string);
    return isNaN(date) ? null : date;
  }
  var parseIso = +new Date("2000-01-01T00:00:00.000Z") ? parseIsoNative : utcParse(isoSpecifier);
  _exports.isoParse = parseIso;
  ...
  _exports.curveCardinal = cardinal;
  ...
  _exports.curveCardinalClosed = cardinalClosed;
  ...
  function stack() {
    ...
    stack.keys = function (_) {
      return arguments.length ? (keys = typeof _ === "function" ? _ : constant$7(slice$4.call(_)), stack) : keys;
    };
  ...
  _exports.zoomIdentity = identity$5;
  ...
  _exports.geoClipAntimeridian = clipAntimeridian;
  ...
  _exports.geoAzimuthalEqualAreaRaw = azimuthalEqualAreaRaw;
  ...
  _exports.geoAzimuthalEquidistantRaw = azimuthalEquidistantRaw;

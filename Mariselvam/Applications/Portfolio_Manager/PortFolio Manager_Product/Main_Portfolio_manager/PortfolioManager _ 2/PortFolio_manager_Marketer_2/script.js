...
let Marketer_submit_function = function(){
    ...
    // Through error Messages end
        ...
        formData.append('MarketerName',Marketer_Name);
        formData.append('MarketerEmail',MarketerEmail);
        formData.append('my_selection',my_selection);
        formData.append('MarketerPwd',MarketerPwd);
        formData.append("Marketer_Image",Marketer_photo[0])
